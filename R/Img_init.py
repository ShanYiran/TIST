...
def image_init(image_path, barcode_path,
    ...
    if (rgb_score == -1):
        ...
        params, cov = curve_fit(bimodal, bins[0:500], n, expected, maxfev=10000)
        result = _solve(*abs(params))
        rgb_score = min(result)
        rgb_score = max(rgb_score, 100)
...
mask_ = image_init(image_path = "D:/Gu_lab/space_expr/data/pubdata/Human_OvarianCancer/spatial/tissue_hires_image.png",
           barcode_path = "D:/Gu_lab/space_expr/data/pubdata/Human_OvarianCancer/spatial/Imginit/barcodes.tsv",
           spot_path = "D:/Gu_lab/space_expr/data/pubdata/Human_OvarianCancer/spatial/tissue_positions_list.csv",
